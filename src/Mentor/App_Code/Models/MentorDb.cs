    ...
    internal sealed class MentorDbMigrationConfiguration : DbMigrationsConfiguration<MentorDb>
    {
        ...
        protected override void Seed(MentorDb context)
        {
            context.Codes.AddOrUpdate(x => x.Id,
                new []
                {
                    new Code { Id=1, Type="Agency.ProgramType", Value="One-on-one mentoring", Label="one mentor with one youth", Seq=1 },
                    new Code { Id=2, Type="Agency.ProgramType", Value="Group mentoring", Label="one mentor with more than one youth", Seq=2 },
                    new Code { Id=3, Type="Agency.ProgramType", Value="Team mentoring", Label="multiple mentors teamed with one youth", Seq=3 },
                    new Code { Id=4, Type="Agency.ProgramType", Value="Multiple groups mentoring", Label="more than one mentor with more than one youth", Seq=4 },
                    new Code { Id=5, Type="Agency.ProgramType", Value="E-mentoring", Label="primarily online", Seq=5 },
